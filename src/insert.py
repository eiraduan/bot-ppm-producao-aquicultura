...
def main():
    ...
    TABELA_DESTINO = "dados_ppm_producao_aquicultura"
    ...
    arquivo_consolidado = PASTA_ARQUIVOS / "PPM_RO_PRODUCAO_AQUICULTURA_FINAL.xlsx"
    ...
    if not arquivo_consolidado.exists():
        ...
        try:
            ...
            df.rename(columns={
                ...
                "Variável": "variavel",
                "Tipo de produto da aquicultura (Código)": "tipo_produto_aquicultura_codigo",
                "Tipo de produto da aquicultura": "tipo_produto_aquicultura"
            }, inplace=True)
